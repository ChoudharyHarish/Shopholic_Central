...
const Wrapper = ({img,title,text1,text2,text3,direction}) => {
  return (
    ...
    <div className='flex justify-center'>
          <img className= {`h-auto  lg:h-full object-cover  max-w-md lg:max-w-full ${direction === '1' ? 'right-3' : 'left-3'} bottom-3`} src={img} alt=""/>
    </div>
  </div>
  </div>
  )
...
const About = () => {
  ...
  return (
    ...
    <div className='py-32 lg:py-20'>
      ...
      <div className='flex flex-col md:mx-4 gap-8 lg:mx-12 xl:mx-20  mt-20'>
